...
//    @StateObject var mapManager = MapViewManager()
//
//    var body: some View {
//        UIMapView(firstLocation: $mapManager.firstLocation)
//            .ignoresSafeArea()
//            .onAppear {
...
//    @Binding var firstLocation: CLLocation?
//
...
//                let cameraUpdate = NMFCameraUpdate(scrollTo: .init(lat: firstLocation.coordinate.latitude, lng: firstLocation.coordinate.longitude))
...
//        // 최초 시작 위치 가져옴.
//        // init시 최초 시작위치가 nil값이므로 UIRepresent의 updateView에서 한번만 불리게 하도록 하기 위함.
